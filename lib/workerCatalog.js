...
const WORKERS = [
  ...
  },
  {
    ...
    countLabels: { local: "غنی‌شده", site: "هدف(لینک‌دار)" },
    defaultArgs: [],
    audit: "profiles",
    local: {
  ...
  },
  {
    ...
    defaultArgs: ["--delay", "800", "--captcha-retries", "20"],
  ...
  },
  {
    ...
    label: "شرکت های مجاز فعال در زمینه واردات تجهیزات و ملزومات پزشکی",
  ...
  },
  {
    ...
    label: "شرکت های وارد کننده دارای نمایندگی تامین کننده مجاز در زمینه واردات تجهیزات و ملزومات پزشکی",
